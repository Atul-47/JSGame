...
function drawEverything() {
	...
	{
	 canvasContext.fillText("Player Won" , 350, 400);
	}
	else if (computerScore >= WINNING_SCORE)
	{
 	 canvasContext.fillText("Computer Won" , 350, 400);	
	}
	...
	colorRect(canvas.width-10,paddle2Y,PADDLE_THICKNESS,PADDLE_HEIGHT,'red');
